...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a @class([ 'active'=> Request::is('service'),
                        'nav-link' => true,
                        ]) aria-current="page" href="/service">Services</a>
                </li>
                <li class="nav-item">
                    <a @class([ 'active'=> Request::is('test_option'),
                        'nav-link' => true,
                        ]) aria-current="page" href="/test_option">Test</a>
                </li>
                <li class="nav-item">
                    <a @class([ 'active'=> Request::is('new_dose'),
                        'nav-link' => true,
                        ]) class="nav-link" href="/new_dose">Dose</a>
                </li>
                <li class="nav-item">
                    <a @class([ 'active'=> Request::is('contact_doc'),
                        'nav-link' => true,
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a @class([ 'active'=> Request::is('login'),
                        'nav-link' => true,
                        ]) class="nav-link" href="/login">Login</a>
                </li>
                <li class="nav-item">
                    <a @class([ 'active'=> Request::is('register'),
                        'nav-link' => true,
                        ]) class="nav-link" href="/register">Register</a>
                </li>
                <li class="nav-item dropdown">
                    <a @class([ 'active'=> Request::is('contact_us'),
                        'nav-link' => true,
