    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a @class(['active'=>Request::is('new_test'), 'nav-link'=>(True)])  aria-current="page" href="/new_test">PCR</a>
                </li>
                <li class="nav-item">
...
<div class="admin-options p-3 bg-dark">
    <div class="container">
        <div class="row">
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a @class(['btn-primary'=> True,'btn-danger'=>Request::is('admin_doc_data'), 'btn' => True]) href="/admin_doc_data"><i class="fa-solid fa-calendar-minus"></i> Doctor Data</a>
                </div>
            </div>
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a @class(['btn-primary'=> True,'btn-danger'=>Request::is('admin_doc_msg'), 'btn' => True]) href="/admin_doc_msg"><i class="fa-solid fa-inbox"></i> Doctor Message</a>
                </div>
            </div>
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a @class(['btn-primary'=> True,'btn-danger'=>Request::is('admin_dose_data'), 'btn' => True]) href="/admin_dose_data" ><i class="fa-solid fa-virus"></i> Dose Data</a>
                </div>
            </div>
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a @class(['btn-primary'=> True,'btn-danger'=>Request::is('admin_test_data'), 'btn' => True]) href="admin_test_data"><i class="fa-solid fa-vials"></i> Test Data</a>
                </div>
            </div>
        </div>
    </div>
