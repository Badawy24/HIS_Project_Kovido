...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('service'),
                        'nav-link' => true,
                        ]) ?>" aria-current="page" href="/service">Services</a>
                </li>
                <li class="nav-item">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('test_option'),
                        'nav-link' => true,
                        ]) ?>" aria-current="page" href="/test_option">Test</a>
                </li>
                <li class="nav-item">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('new_dose'),
                        'nav-link' => true,
                        ]) ?>" class="nav-link" href="/new_dose">Dose</a>
                </li>
                <li class="nav-item">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('contact_doc'),
                        'nav-link' => true,
...
<div class="admin-options p-3 bg-dark">
    <div class="container">
        <div class="row">
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'btn-primary'=> true,
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('login'),
                        'nav-link' => true,
                        ]) ?>" class="nav-link" href="/login">Login</a>
                </li>
                <li class="nav-item">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('register'),
                        'nav-link' => true,
                        ]) ?>" class="nav-link" href="/register">Register</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([ 'active'=> Request::is('contact_us'),
                        'nav-link' => true,
...
<?php endif; ?><?php /**PATH C:\Users\Badawy\Desktop\New folder\HIS_Project_Kovido\resources\views/navbar.blade.php ENDPATH**/ ?>