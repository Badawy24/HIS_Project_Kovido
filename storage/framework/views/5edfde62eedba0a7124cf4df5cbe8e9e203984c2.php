        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['active'=>Request::is('contactUs'), 'nav-link'=>(True)]) ?>" class="nav-link" href="/contactUs">Contact Us</a>
                </li>
            </ul>
        </div>
    </div>
</nav>
<?php /**PATH C:\Users\Badawy\Desktop\HIS_Proj\resources\views/navbar.blade.php ENDPATH**/ ?>