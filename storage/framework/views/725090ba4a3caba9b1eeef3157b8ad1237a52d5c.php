                        ...
                        <div class="card px-2 py-2 mb-5" style="min-width: 100%">
                            ...
                            <div class="card-body">
                                <form action="" method="POST" class="row">
                                    <?php echo csrf_field(); ?>
                                    <input class="inp-form form-control" type="hidden" name="meetinId">
                                    <div class="col-lg-12">
...
<?php echo $__env->make('main-template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\third_year_training\HIS_Project_Kovido\resources\views/meeting/confirm.blade.php ENDPATH**/ ?>