                                    ...
                                    <div class="card px-2 py-2 mb-5" style="min-width: 100%">
                                        <div class="card-body text-start">
                                            ...
                                            <div class="real-data live-doc">
                                                ...
                                                <span class="h6">
                                                    <?php echo e($meetAdmin[0]->meet_date); ?>
                                            ...
                                            <div class="real-data live-doc">
                                                ...
                                                <span class="h6">
                                                    <?php echo e(date('H:i', strtotime($meetAdmin[0]->meet_time))); ?>
                                            ...
                                            <div class="real-data live-doc">
                                                ...
                                                <span class="h6">
                                                    <?php echo e($meetAdmin[0]->meet_desc); ?>

                                                </span>
                                            </div>
                                        </div>
                                        <div class="card-body">
                                            <form action="/joinMeetingAdminDoc/<?php echo e($doc_id); ?>" method="get"
                                                class="d-inline-block">
                                                <input type="hidden" id="joinMeetingId"
                                                    value="<?php echo e($meetAdmin[0]->meet_admin_id); ?>">
                                                <?php if(date('Y-m-d H:i', strtotime('+2 hours')) < $meetAdmin[0]->meet_date . ' ' . $meetAdmin[0]->meet_time): ?>
                                            ...
                                            <form action="/admin_meet_del/<?php echo e($meetAdmin[0]->meet_id); ?>"
                                                class=" d-inline-block">
                                        ...
                                        <div class="card px-2 py-2 mb-5" style="min-width: 100%">
                                            <div class="card-body text-start">
                                                ...
                                                <div class="real-data live-doc">
                                                    <h5 class="live-doc-card">Time :</h5>
                                                    <span class="h6">
                                                        <?php echo e(date('H:i', strtotime($meeting->con_time))); ?>
