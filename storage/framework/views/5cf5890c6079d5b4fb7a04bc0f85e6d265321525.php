...
<div class="admin-options p-3 bg-dark">
    <div class="container">
        <div class="row">
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['btn-primary'=> True,'btn-danger'=>Request::is('admin_doc_data'), 'btn' => True]) ?>" href="/admin_doc_data"><i class="fa-solid fa-calendar-minus"></i> Doctor Data</a>
                </div>
            </div>
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['btn-primary'=> True,'btn-danger'=>Request::is('admin_doc_msg'), 'btn' => True]) ?>" href="/admin_doc_msg"><i class="fa-solid fa-inbox"></i> Doctor Message</a>
                </div>
            </div>
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['btn-primary'=> True,'btn-danger'=>Request::is('admin_dose_data'), 'btn' => True]) ?>" href="/admin_dose_data" ><i class="fa-solid fa-virus"></i> Dose Data</a>
                </div>
            </div>
            <div class='col-md-3'>
                <div class="opt-btn">
                    <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['btn-primary'=> True,'btn-danger'=>Request::is('admin_test_data'), 'btn' => True]) ?>" href="admin_test_data"><i class="fa-solid fa-vials"></i> Test Data</a>
                </div>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\DELL\OneDrive\Desktop\new clone\HIS_Project_Kovido\resources\views/navbar.blade.php ENDPATH**/ ?>