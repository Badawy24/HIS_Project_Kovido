                    ...
                    <article class="col-md-5 d-flex align-items-stretch">
                        <div class="card px-2 py-2 mb-5" style="min-width: 100%">
                            ...
                            <div class="card-body text-start">
                                <h4 class="card-title mb-4">Name : <?php echo e($patient->pat_fname . ' ' . $patient->pat_lname); ?>

                                </h4>
                                <h4 class="card-title mb-4">Doctor : <?php echo e($doctor->doc_fname . ' ' . $doctor->doc_lname); ?>
