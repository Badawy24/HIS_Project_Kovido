...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-6 update-inp">
                        ...
                        <input class="form-control" name="pat_DOF" type="date" placeholder="pat_DOF"
                            aria-label="default input example" value="<?php echo e($pat->pat_DOF); ?>" max="<?php echo date_format($dateBrith, 'Y-m-d'); ?>">
...
<?php echo $__env->make('admin.admin-dashbord-temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\OneDrive\Desktop\3rd_p\HIS_Project_Kovido\resources\views/admin/admin_update_patient.blade.php ENDPATH**/ ?>