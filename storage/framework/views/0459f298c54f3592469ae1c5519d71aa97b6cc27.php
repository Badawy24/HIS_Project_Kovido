...
<form action="/admin_add_patient" method="post" class="row" id="admin_patient">
    ...
    <?php echo csrf_field(); ?>
    <div class="col-md-6">
        <input class=" form-control" type="text" placeholder="First Name" name="pat_fname" value="<?php echo e(old('pat_fname')); ?>" id="name" aria-label="default input example">
...
unset($__errorArgs, $__bag); ?> -->
    ...
    <div class="col-md-6">
        <input class="form-control col-auto" type="text" placeholder="Last Name" name="pat_lname" value="<?php echo e(old('pat_lname')); ?>" id="name" aria-label="default input example">
...
unset($__errorArgs, $__bag); ?> -->
    ...
    <div class="col-lg-12">
        <input class=" form-control" type="email" placeholder="Patient Email" name="pat_email" value="<?php echo e(old('pat_email')); ?>" id="email" aria-label="default input example">
...
unset($__errorArgs, $__bag); ?> -->
    ...
    <div class="col-lg-12">
        <input class=" form-control" type="text" placeholder="Address" name="pat_address" value="<?php echo e(old('pat_address')); ?>" id="address" aria-label="default input example">
...
unset($__errorArgs, $__bag); ?> -->
    ...
    <div class="col-lg-12">
        <input class=" form-control" type="tel" placeholder="Phone Number" name="pat_phone" value="<?php echo e(old('pat_phone')); ?>" id="phone" aria-label="default input example">
...
unset($__errorArgs, $__bag); ?> -->
    ...
    <div class="col-lg-12">
        ...
        <input class=" form-control" type="date" placeholder="Birth Of Date" name="pat_DOF" id="BOD" value="<?php echo e(old('pat_BOF')); ?>" aria-label="default input example">
