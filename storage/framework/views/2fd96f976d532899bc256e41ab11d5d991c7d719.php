                ...
                <div class="row">
                    ...
                    <p class="lead"><b>Time :</b> <?php $date = date('d-m-y h:i:s'); echo $date; ?></pclass->
                        ...
                        <div class="doc col-12">
                            ...
                            <p class="lead"><strong>Date : </strong> <?php echo e($test->pat_test_date . ' ' . $test->pat_test_time); ?> </p>
...
<?php echo $__env->make('admin.admin-dashbord-temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH A:\Laravel-project\final-web\HIS_Project_Kovido\resources\views/admin/admin_test_data.blade.php ENDPATH**/ ?>