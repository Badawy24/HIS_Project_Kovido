    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses(['active' => Request::is('doc_profile'), 'nav-link' => true]) ?>"
                            href="/doc_profile"><?php
                            $id = Session::get('doc_user_id');
                            $doc = DB::select('select doc_fname, doc_lname from doctor where doc_id = ?', [$id]);
                            ?><?php echo e('Dr/ ' . $doc[0]->doc_fname . ' ' . $doc[0]->doc_lname); ?>

                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            'active' => Request::is('doc_profile_msg'),
                            'nav-link' => true,
                        ]) ?>" class="nav-link" href="/doc_profile_msg">Message</a>
                    </li>
                    <li class="nav-item">
                        <a class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                            'active' => Request::is('startMeetingDoc'),
                            'nav-link' => true,
                        ]) ?>" class="nav-link" href="/startMeetingDoc">Mettings</a>
                    </li>
...
<?php endif; ?>
<?php /**PATH C:\Users\Badawy\Desktop\v0.2\HIS_Project_Kovido\resources\views/navbar.blade.php ENDPATH**/ ?>