            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="t_action_col_width">
                        <button class="btn btn-primary mb-3 submit table_button" style="background-color:rgb(74, 129, 172)" onclick="window.location.href = '/update_test/<?php echo e($testcase->res_id); ?>';"> Edit </button>
                        <button class="btn btn-primary mb-3 submit table_button" style="background-color:rgb(151, 39, 39)" onclick="window.location.href = '/delete/<?php echo e($testcase->res_id); ?>';"> Remove </button>
                    </td>
...
<?php echo $__env->make('main-template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Badawy\Desktop\v0.2\HIS_Project_Kovido\resources\views/my_tests.blade.php ENDPATH**/ ?>