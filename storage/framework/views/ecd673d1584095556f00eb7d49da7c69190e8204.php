                                ...
                                <?php $__currentLoopData = session('doc_msg'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $msg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="report-icon">
                                            <a href="/admin_doc_msg/<?php echo e($msg->msg_id); ?>">
...
<?php echo $__env->make('admin.admin-dashbord-temp', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Badawy\Desktop\vvv\HIS_Project_Kovido\resources\views/admin/admin_doc_msg.blade.php ENDPATH**/ ?>